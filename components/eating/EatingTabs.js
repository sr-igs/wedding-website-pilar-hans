...
const favourites = [
    ...
    {title:"Navarro",link:"https://restaurantenavarro.com/en/",description:`If you’d like to try the traditional Valencian cuisine, this is (for us) the best place. Located very close to the city hall, this restaurant has been run by the same family for decades, and you will be able to find all kinds of paellas and other Valencian dishes. It also offers a great selection of fish and seafood, as well as seasonal vegetables and dishes. 
...
const spanish = [
    {title:"Entrevins",link:"https://www.entrevins.es/en/",description:`Located on the first floor of a building in the “La Paz” street, one of the most beautiful streets in Valencia, this restaurant is run by Guillaume - one of the best sommeliers of Valencia. You can therefore pair exquisite dishes with one of the wine menus in the city.
    If you go Monday to Friday, it has a “menu del dia” (menu of the day) a deal which allows you to eat at a very reasonable price for the quality of the food.
    ...
    {title:"Asador de Aranda",link:"https://asadordearanda.net/restaurante/asador-de-aranda-valencia/",description:`A restaurant that offers typical food from the “Castilla” region of Spain. Its specialities are oven roasted “lechazo” (lamb) and “cochinillo” (pork), along with other central Spainish classics such as “morcilla” (Black pudding with rice) and chorizo. The restaurant is decorated with a classical yet elegant style. It is a chain restaurant that is present all around Spain, but which still offers a quick and efficient service and great quality food.`,address:"C/ Felix Pizcueta, 6, 46004"},
    ...
    Even though it is part of a chain present all around Spain, it is well worth a visit for its food, ambiance and service. The ground floor offers “pintxos” (small tapas on slices of bread) where you can try a variety of dishes; be aware that this is usually full and you cannot book in this area - so you'll have to try your luck as a walk-in!
    `,address:"C/ San Vicente Martir, 6, 46002"},
    {title:"Armonia",link:"https://armoniarestaurante.eatbu.com/?lang=en",description:`Located very close to the city hall and run by Monia and Ernesto. They specialise in market based food with Valencian roots. The menu changes depending on whatever fresh food the market has to offer. They also offer a traditional dish that changes daily.`,address:"C/ Ribalta, 6, 46001"},
    {title:"Quesomentero",link:"https://quesomentero.com/",description:`If you love cheese, this is your place! They offer cheese boards with a variety of international cheeses, from classics to the very unique (we’ve tried a cheese that was aged for 25 years). Although cheese is the main offering, it also offers charcuterie and tapas. If you order a cheese board, you will get a detailed explanation from the waiters going through each cheese - it might however be in Spanish only!`,address:"C/ Maestre Clavé, 8, 46001"}
]
...
const wines = [
    {title:"La Piccola Enoteca",link:"https://www.tripadvisor.com/Restaurant_Review-g652037-d2436657-Reviews-La_Piccola_Enoteca-Montecarlo_Province_of_Lucca_Tuscany.html",description:`A quaint and cosy wine bar exquisitely decorated by the owners, Roberto and Maria -  an accurate reflection of their eccentric personalities. There is an ample selection of Italian wines and a food menu based on cheese, charcuterie and some Italian classics such as Bruscetta and Parmigiana. `,address:"C/ del Pintor Salvador Abril, 13,46005"},
    {title:"Cantina Matiz",link:"https://www.carteleraturia.com/cantina-matizvariedad-y-calidad/",description:`Small restaurant located very close to the city hall, with an excellent wine selection curated and recommended by Tizziana. In the kitchen, located just behind the bar, Marco cooks some simple but delicious food, focusing on salads and cheese and charcuterie boards. Their variety of carpaccios are also worth noting.`,address:"Plaza dels Porxets,1,46001"},
