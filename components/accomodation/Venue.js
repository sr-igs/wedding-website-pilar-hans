...
export default function VenueStay(){
    return(
        <div className={styles.mainDiv}>
            ...
            <a className={styles.hotelLink} href="https://www.onlyyouhotels.com/en/hotels/only-you-hotel-valencia/" target="_blank" rel="noreferrer"> {"their website. It is also pet friendly!"}</a></p>
            </div>
