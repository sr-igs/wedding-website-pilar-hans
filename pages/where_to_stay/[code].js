...
export default function WhereToStayPage(props){
    const closeHotelOptions = [
        ...
        {name:"One Shot Palacio Reina Victoria 04",link:"https://www.hoteloneshotpalacioreinavictoria04.com/en/?gclid=EAIaIQobChMIjcnoxvWO-wIVSJ7tCh3Drg9aEAAYASAAEgJwjPD_BwE",stars:"****",location:"Barcas, 4, Ciutat Vella",description:"Stay in the first hotel of the city, inaugurated back in 1913. It was fully refurbished in 2016 and offers a great option close to the venue and church."},
        ...
        {name:"Marques House Hotel Sup",link:"https://myrhotels.com/en/hotels/hotel-marques-house/",stars:"****",location:"Carrer de l'Abadia de San Marti, 10, Ciutat Vella",description:"Just 5 minutes away from the venue and hotel and also very close to the cathedral square, this modern hotel is at the place where famous Agua de Valencia was created."},
    ...
    const otherHotelOptions = [
        ...
        {name:"Vincci Lys",link:"https://www.guestreservations.com/Hotel-vincci-lys-valencia/",stars:"****",location:"Martinez Cubells, 5",description:"A classic hotel in Valencia that is under a 10 minute walk from the venue and church."},
